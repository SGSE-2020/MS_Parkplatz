...
goog.exportSymbol('proto.user.Date', null, global);
 ...
 * @constructor
 */
proto.user.Date = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.user.Date, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.Date.displayName = 'proto.user.Date';
}
...
proto.user.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    birthdate: (f = msg.getBirthdate()) && proto.user.Date.toObject(includeInstance, f),
    ...
    iactive: jspb.Message.getBooleanFieldWithDefault(msg, 13, false)
  };
...
proto.user.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.user.Date;
      reader.readMessage(value,proto.user.Date.deserializeBinaryFromReader);
...
proto.user.User.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.user.Date.serializeBinaryToWriter
    );
  }
...
/**
 * optional Date birthDate = 7;
 * @return {?proto.user.Date}
 */
proto.user.User.prototype.getBirthdate = function() {
  return /** @type{?proto.user.Date} */ (
    jspb.Message.getWrapperField(this, proto.user.Date, 7));
};


/**
 * @param {?proto.user.Date|undefined} value
 * @return {!proto.user.User} returns this
*/
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.clearBirthdate = function() {
 ...
 * @return {boolean}
 */
proto.user.User.prototype.hasBirthdate = function() {
...
/**
 * optional bool iActive = 13;
 * @return {boolean}
 */
proto.user.User.prototype.getIactive = function() {
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.setIactive = function(value) {
 ...
 * @return {!Object}
 */
proto.user.Date.prototype.toObject = function(opt_includeInstance) {
  return proto.user.Date.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.Date} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.Date.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.user.Date}
 */
proto.user.Date.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.Date;
  return proto.user.Date.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.Date} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.Date}
 */
proto.user.Date.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.Date.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.Date.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.Date} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.Date.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getYear();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.user.Date.prototype.getYear = function() {
...
/**
 * @param {number} value
 * @return {!proto.user.Date} returns this
 */
proto.user.Date.prototype.setYear = function(value) {
 ...
 * @return {number}
 */
proto.user.Date.prototype.getMonth = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.user.Date} returns this
 */
proto.user.Date.prototype.setMonth = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.user.Date.prototype.getDay = function() {
 ...
 * @return {!proto.user.Date} returns this
 */
proto.user.Date.prototype.setDay = function(value) {
